 ...
 */
public class Hessian2ObjectInputExtension implements ObjectInput {
    private final Hessian2Input mH2i;

    public Hessian2ObjectInputExtension(InputStream is) {
        mH2i = new Hessian2Input(is);
        mH2i.setSerializerFactory(Hessian2SerializerFactoryExtension.SERIALIZER_FACTORY);
    }
